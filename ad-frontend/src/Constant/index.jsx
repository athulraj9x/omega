export const TRANSLATION_FILE_PATH = process.env.REACT_APP_TRANSLATION_FILE_PATH;
...
export const CreditReference = "CREDIT_REFERENCE";
export const MyBalance = "MY_BALANCE";
...
// Default Dashboard //
export const WelcomeToCuba = "WELCOME_TO_CUBA";
export const WelcomeMessage = "WELCOME_MESSAGE";
...
export const CurrencyName = "Currency Name";
...
export const SportShares = "Sports Share";
export const CasinoShares = "Casino Share";
...
export const Roles = [
  ...
  { label: "Admin", value: 2 },
  { label: "Double Super", value: 3 },
  { label: "Super Master", value: 4 },
  { label: "Master", value: 5 },
  // { label: "Agent", value: 6 },
  { label: "User", value: 7 },
];
export const WhiteLabelB2CRoles = [{ label: "User", value: 7 }];
...
export const Actions = [
  { label: "Active", value: "status" }, //value :1
  { label: "Bet Allow", value: "betAllow" }, //value:2
];
...
export const exchangeMarketPriority = {
  "Match Odds": 1,
  LINE: 2,
};

export const eventMarketPriority = {
  "Match Odds": 1,
  BOOKMAKER: 2,
};

export const defaultResultValues = [
  { label: "Void", value: "void" },
  { label: "Abandonned", value: "abandonned" },
  { label: "Tie", value: "tie" },
];
...
export const availableCasinos = [
  { label: "All", value: 0 },
  { label: "No Casino", value: null },
  { label: "Live Casino", value: 1 },
  { label: "Indian Casino", value: 2 },
];
...
export const ManagerOptions = [
  { label: "Manager", value: 1.1 },
  { label: "Accounts Manager", value: 1.2 },
  { label: "Operational Manager", value: 1.3 },
  { label: "Monitoring Manager", value: 1.4 },
  { label: "Fancy Manager", value: 1.25 },
];

export const ManagerMonitorAccessibility = [
  { label: "Director", value: 1 },
  { label: "Others", value: 2 },
];

export const CURRENCY_VIEW = [1, 1.2];

export const ManagerRoles = {
  MANAGER: 1.1,
  ACCOUNTS_MANAGER: 1.2,
  OPERATIONAL_MANAGER: 1.3,
  MONITORING_MANAGER: 1.4,
  FANCY_MANAGER: 1.25,
};

export const CurrencyConversionRoles = 1.5;

export const ManagerTypes = {
  MANAGER: "Managers",
  ACCOUNTS_MANAGER: "Accounts Managers",
  OPERATIONAL_MANAGER: "Operational Managers",
  MONITORING_MANAGER: "Monitoring Managers",
  FANCY_MANAGER: "Fancy Managers",
};
...
export const BET_TABLE_OPTIONS = [
  { label: "ADMIN", value: "ADMIN" },
  { label: "USER", value: "USER" },
];
//default currency Pattern
export const DEFAULT_CURRENCY_PATTERN = /indian\s*rup[ee]es|inr/gi;
